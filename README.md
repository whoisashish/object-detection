...
Direct way: run [this Colab Notebook](https://colab.research.google.com/drive/1vWStF7lW3kHwRncKfxk1UCV_O3l-wnrO).
...
```
https://github.com/whoisashish/object-detection
```
...
### Step 2: Open [Colab notebook](https://colab.research.google.com/drive/1vWStF7lW3kHwRncKfxk1UCV_O3l-wnrO)
